...
profile1 = profileCard(id="profile1",name="Lady Milena Nieves Mendoza",profileDescription="Economist and Master's student on Project Management. Data analyst with 6 years of experience for consulting and financial companies. Skills on data collection, data processing, statistical and econometric modelling, data reporting and R programming language. Passionate about data visualization.", profession="Economist", linkedIn="milenanieves")
...
profile4 = profileCard(id="profile4",name="Juan Pablo Lancheros",profileDescription="Industrial engineer focused on logistics and supply chains in foreign trade, currently working in the area of imports.", profession="Industrial Engineer", linkedIn="juan-pablo-lancheros-ab281127")
...
profile7 = profileCard(id="profile7",name="Andres Felipe Guzman Romero",profileDescription="", profession="Systems Engineer", linkedIn="andres-felipe-guzmán-romero-a8756b26")
